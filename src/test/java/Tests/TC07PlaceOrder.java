...
public class TC07PlaceOrder {@BeforeMethod
public void SetupWebsite() throws IOException {
    ...
    @Owner("Ahmed Hassan")
    @Description("Verify that order placed is displayed correctly")
    @Test
    public void VerifyThatOrderPlacedMessageIsDisplayed() throws IOException {
        //todo: Select Product
        ...
        Assert.assertTrue(new P07PlaceOrder(getDriver()).CheckIfOrderPlacedIsDisplayed());
    }
